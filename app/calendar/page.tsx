      ...
      <main className="flex-1">
        ...
        <section className="relative py-24 px-4 overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-0 right-1/4 w-96 h-96 bg-daycare-green/20 rounded-full blur-3xl animate-float" />
        ...
        <section className="py-20 px-4 relative overflow-hidden">
          ...
          <div className="container mx-auto max-w-4xl relative z-10">
            ...
            <div className="backdrop-blur-xl bg-white/60 dark:bg-gray-900/60 border border-white/20 dark:border-gray-700/20 rounded-2xl p-8 shadow-xl mb-8">
              {/* Header with icon */}
